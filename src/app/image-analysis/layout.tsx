...
export const metadata: Metadata = {
  title: 'Image Analysis - Quality Assessment Tool',
  description:
    'Analyze image quality using advanced algorithms including Rule of Thirds, Golden Ratio, symmetry, and composition analysis. Get detailed metrics and insights about your images.',
  keywords:
